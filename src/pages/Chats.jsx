...
export const DEMO_HISTORIES = {
  5: [
    ...
    { id: 2, from: 'helper', text: '¡Hola! Sí, claro. ¿Qué tipo de ayuda necesita principalmente? ¿Más asistencia con la higiene personal, compañía, o gestión de medicación?', time: new Date(Date.now() - 1000*60*60*2.8).toISOString() },
    ...
    { id: 4, from: 'helper', text: 'Entiendo perfectamente. Tengo experiencia específica con Alzheimer en fase inicial y en esa zona además. ¿Podría ser de 9 a 13h? Mi tarifa para ese horario sería de 14€/h.', time: new Date(Date.now() - 1000*60*60*2).toISOString() },
    ...
    { id: 6, from: 'helper', text: 'Mañana a las 9:30 en su domicilio entonces. Le mando ubicación por aquí 🙂', time: new Date(Date.now() - 1000*60*12).toISOString() },
  ],
  1: [
    ...
    { id: 2, from: 'helper', text: '¡Hola! La dislalia de la R es muy común a esa edad y tiene muy buen pronóstico con tratamiento. ¿Ha tenido evaluación previa o sería la primera vez?', time: new Date(Date.now() - 1000*60*60*4.5).toISOString() },
    ...
    { id: 4, from: 'helper', text: 'Perfecto, haríamos primero una sesión de evaluación (45 min, 50€) y de ahí establecemos el plan. Suelo trabajar en Gràcia, ¿les queda bien la zona?', time: new Date(Date.now() - 1000*60*60*3.5).toISOString() },
    { id: 5, from: 'user', text: 'Sí, vivimos en Gràcia. ¿Tiene hueco esta semana?', time: new Date(Date.now() - 1000*60*90).toISOString() },
    { id: 6, from: 'helper', text: 'Perfecto, el jueves a las 17h para la primera sesión. La niña no necesita traer nada.', time: new Date(Date.now() - 1000*60*58).toISOString() },
  ],
  3: [
    ...
    { id: 2, from: 'helper', text: '¡Entendido, salgo en 40 minutos! Dígame la dirección y el modelo de caldera si lo sabe.', time: new Date(Date.now() - 1000*60*60*7.8).toISOString() },
    ...
    { id: 4, from: 'helper', text: 'Perfecto. Conozco bien ese modelo. Llevo recambios habituales por si hace falta.', time: new Date(Date.now() - 1000*60*60*7).toISOString() },
    { id: 5, from: 'user', text: '¿Cuánto puede costar aproximadamente?', time: new Date(Date.now() - 1000*60*60*6.5).toISOString() },
    { id: 6, from: 'helper', text: 'Visita + mano de obra 65€, más recambios si hacen falta. Cuando vea lo que es le confirmo.', time: new Date(Date.now() - 1000*60*60*6).toISOString() },
    { id: 7, from: 'helper', text: 'Ya está revisada. Era la válvula de expansión. Le dejo factura en el buzón.', time: new Date(Date.now() - 1000*60*60*4).toISOString() },
  ],
  7: [
    ...
    { id: 2, from: 'helper', text: '¡Hola! ¿Sabes si tiene más dificultad con álgebra o con geometría? ¿Y en física más con problemas o con la teoría?', time: new Date(Date.now() - 1000*60*60*49).toISOString() },
    ...
    { id: 4, from: 'helper', text: 'Perfecto, son cosas muy trabajables. Hago clases los martes y jueves de 17 a 19h, 30€/hora. ¿Le viene bien?', time: new Date(Date.now() - 1000*60*60*47).toISOString() },
    { id: 5, from: 'user', text: 'Sí, los martes perfecto. ¿Puede ser en casa?', time: new Date(Date.now() - 1000*60*60*30).toISOString() },
    { id: 6, from: 'helper', text: 'Esta semana repasamos álgebra, que es donde más le cuesta. Avanzando bien 💪', time: new Date(Date.now() - 1000*60*60*26).toISOString() },
  ],
  9: [
    ...
    { id: 2, from: 'helper', text: 'Hola. Gracias por dar el paso, sé que no es fácil. ¿Cuánto tiempo llevas así? ¿Ha habido algún acontecimiento específico o ha ido apareciendo gradualmente?', time: new Date(Date.now() - 1000*60*60*71).toISOString() },
    ...
    { id: 4, from: 'helper', text: 'Es muy frecuente ese patrón. Trabajo principalmente con TCC y mindfulness para estos casos. La primera sesión es de evaluación, 60€. ¿Prefiere presencial u online?', time: new Date(Date.now() - 1000*60*60*69).toISOString() },
    ...
    { id: 6, from: 'helper', text: 'Para la próxima sesión intente el ejercicio de diario que comentamos. Hasta el viernes.', time: new Date(Date.now() - 1000*60*60*48).toISOString() },
  ],
}
